  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 pb-2">
        <input type="text" value={search} onChange={(e) => setSearch(e.target.value)} placeholder={t('search.placeholder')} className="w-full bg-[#111111] border border-[#1E1E1E] rounded-lg px-3 py-2 text-sm text-[#F0F0F0] placeholder:text-[#444444] outline-none focus:border-[#333333]" />
      </div>
      <div className="flex-1 overflow-y-auto">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-[#555555]"><p className="text-sm">{t('common.no_data')}</p></div>
        ) : (
