...
export const SPORT_LEAGUES: Record<Sport, string[]> = {
  football: ['Premier League', 'La Liga', 'Serie A', 'Bundesliga', 'Ligue 1', 'UEFA Champions League', 'Europa League', 'MLS', 'Brasileirao', 'Saudi Pro League'],
  basketball: ['NBA', 'WNBA', 'EuroLeague', 'ACB Liga Endesa', 'BBL', 'LNB Pro A', 'NCAA Basketball', 'FIBA World Cup'],
  handball: ['EHF Champions League', 'EHF European League', 'Liqui Moly Bundesliga', 'Liga ASOBAL', 'LNH Division 1', 'Danish Handball League'],
  tennis: ['ATP Tour', 'WTA Tour', 'Wimbledon', 'US Open', 'Roland-Garros', 'Australian Open', 'Davis Cup', 'Billie Jean King Cup'],
  volleyball: ['CEV Champions League', 'PlusLiga', 'SuperLega', 'Ligue A', 'Sultanlar Ligi', 'Nations League'],
  boxing: ['World Boxing Championships', 'WBC', 'WBA', 'IBF', 'WBO'],
  mma: ['UFC', 'PFL', 'ONE Championship', 'Bellator'],
  esports: ['League of Legends Worlds', 'LCK', 'LPL', 'LEC', 'LCS', 'Counter-Strike Majors', 'VALORANT Champions'],
  formula1: ['Formula 1', 'Formula 2', 'Formula 3'],
  padel: ['Premier Padel', 'World Padel Tour', 'A1 Padel'],
  hockey: ['NHL', 'KHL', 'SHL', 'Liiga', 'DEL', 'National League'],
  baseball: ['MLB', 'NPB', 'KBO League', 'World Baseball Classic'],
  cricket: ['ICC Cricket World Cup', 'Indian Premier League', 'The Ashes', 'Big Bash League', 'T20 World Cup'],
  rugby: ['Six Nations', 'Rugby World Cup', 'Top 14', 'Premiership Rugby', 'United Rugby Championship', 'Super Rugby'],
  cycling: ['Tour de France', 'Giro d’Italia', 'Vuelta a España', 'UCI WorldTour'],
  athletics: ['Olympic Games', 'World Athletics Championships', 'Diamond League'],
  swimming: ['Olympic Games', 'World Aquatics Championships', 'World Swimming Championships'],
  skiing: ['Alpine Ski World Cup', 'FIS World Championships', 'Winter Olympics'],
  golf: ['PGA Tour', 'DP World Tour', 'The Masters', 'US Open', 'The Open Championship', 'Ryder Cup'],
  badminton: ['BWF World Tour', 'Thomas Cup', 'Uber Cup', 'Olympic Games'],
  kabaddi: ['Pro Kabaddi League', 'Kabaddi World Cup', 'Asian Games'],
  sumo: ['Grand Sumo Tournament', 'Haru Basho', 'Natsu Basho', 'Kyushu Basho'],
  futsal: ['FIFA Futsal World Cup', 'UEFA Futsal Champions League', 'AFC Futsal Asian Cup'],
  polo: ['Polo World Championship', 'Argentine Open', 'British Open Polo Championship'],
  squash: ['PSA World Tour', 'World Squash Championships', 'British Open'],
  netball: ['Netball World Cup', 'Suncorp Super Netball', 'ANZ Premiership'],
  rally: ['World Rally Championship', 'Dakar Rally', 'European Rally Championship'],
  'muay thai': ['ONE Championship', 'WBC Muay Thai', 'Rajadamnern Stadium'],
  'water polo': ['FINA Water Polo World League', 'LEN Champions League', 'Water Polo World Championships'],
  gymnastics: ['World Artistic Gymnastics Championships', 'Olympic Games', 'European Championships'],
  wrestling: ['Wrestling World Championships', 'Olympic Games', 'WWE'],
}
...
export const COUNTRY_PROFILES: Record<string, CountryProfile> = {
  ...
  DZ: { name: 'Algeria',     flag: '🇩🇿', sports: ['football','rugby','hockey','basketball','baseball','cricket','volleyball','handball','tennis','boxing','mma','esports'], topLeagues: ['Ligue 1 Algérie','Championnat d’Algérie de Handball'] },
  ...
  DEFAULT: { name: 'Global', flag: '🌍', sports: ['football','basketball','handball','tennis','volleyball','boxing','mma','esports','formula1','padel'], topLeagues: ['Premier League','NBA','EHF Champions League','ATP Tour','Formula 1'] },
}
