  ...
  return (
    <Link href="/" aria-label="ScoreAvenue">
      <svg viewBox={`0 0 ${s.b * 5.5} ${s.b}`} width={s.b * 5.5} height={s.b}>
        ...
        <line x1="0" y1={s.b/2} x2={s.b} y2={s.b/2} stroke="#8B5CF6" strokeWidth="2"/>
        ...
        <text x={s.b*1.24} y={s.b*0.88} fontFamily="Trebuchet MS,sans-serif" fontSize={s.st} fontWeight="600" fill="#94A3B8" letterSpacing={s.sp}>AVENUE</text>
      </svg>
    </Link>
  )
}
